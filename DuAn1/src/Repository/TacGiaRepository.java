...
public class TacGiaRepository {
    ...
    public int createTacGiaRepository(TacGia tg) {
        int ketQuaTruyVan = -1;
        try ( Connection con = DBConnect_QA.getDatabaseConnection();  PreparedStatement sttm = con.prepareStatement(insert)) {
    ...
    public int updateTacGiaRepository(TacGia tg) {
        int ketQuaTruyVan = -1;
        try ( Connection con = DBConnect_QA.getDatabaseConnection();  PreparedStatement sttm = con.prepareStatement(update)) {
            sttm.setString(1, tg.getMa());
            sttm.setString(2, tg.getTen());
    ...
    public int deleteTacGiaRepository(String id) {
        int ketQuaTruyVan = -1;
        try ( Connection con = DBConnect_QA.getDatabaseConnection();  PreparedStatement sttm = con.prepareStatement(delete)) {
